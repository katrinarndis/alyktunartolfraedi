...
-   **Þýðistölur** eru þau gildi sem myndu fást ef við hefðum aðgang að
    ...
    -   Gefum okkur að við viljum vita hæð Íslendinga, það er einhver
        meðalhæð sem fengist ef **öll stök þýðis** væru mæld.

    -   Það er þó sjaldnast hægt að mæla *alla* sem þýði samanstendur af
...
### Dæmi sem unnið verður með. {.unnumbered}

*Við viljum vita hvort háskólamenntaðir, í samanburði við þá sem ekki
...
<!-- Þessi spurning gefur til kynna að við séum með tvo hópa af fólki og athugum hvort munur sé á meðallaunum hópana. Eftir því hvernig við kjósum að mæla breyturnar og hvaða tölfræðiaðferð við notum gæti spurningin þó verið sett upp á ólíkan hátt. -->
